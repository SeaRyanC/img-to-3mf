...
The 3MF file format is generated by:

1. Creating voxels (3D boxes) for each pixel that matches a color
2. Stacking color layers vertically based on specified heights
3. Generating proper 3MF XML structure with materials and geometry
4. Packaging everything into a ZIP file with the `.3mf` extension
